...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.06), July 08, 2014, at 15:00
...
for thisTrial_120 in trials_120:
    ...
    for thisWithinATrial_fill_4_sec in withinATrial_fill_4_sec:
        ...
        while continueRoutine:
            ...
            elif pattern1.status == STARTED and frameN >= (pattern1.frameNStart + 3):
                pattern1.setAutoDraw(False)
            
            # *pattern2* updates
            if frameN >= 3 and pattern2.status == NOT_STARTED:
                # keep track of start time/frame for later
            ...
            elif pattern2.status == STARTED and frameN >= (pattern2.frameNStart + 2):
